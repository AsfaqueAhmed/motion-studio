...
- [Phase 16 Testing decisions](project_phase16_testing.md) — unit gap audit (not from scratch), real-browser integration tier via @vitest/browser+Playwright, E2E scope cut to Trim/Export/TTS UI not existing, playwright.config.ts baseURL bug + dnd-kit click-suppression bug found
